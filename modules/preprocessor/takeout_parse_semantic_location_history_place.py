...
#---------------------------------------------------------------------------------------------------------------
    def parse_activity_place(case):
        file_path = case.takeout_semantic_location_history_path + os.sep + '2019' + os.sep + '2019_SEPTEMBER.json'
        if os.path.exists(file_path) == False:
            return False

        data = json.load(open(file_path,'r', encoding='utf-8'))
        # print(data.keys())
        # print(data['timelineObjects'][0])
        # print(data['timelineObjects'])
        # print(len(data['timelineObjects']))
